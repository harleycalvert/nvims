...
func main() {
	...
	mux.HandleFunc("POST /vcc/new",                                        P("vcc:access", h.VCCCreate))
	...
	mux.HandleFunc("GET /admin/sessions/teacher-suggestions",          P("sessions:view",   h.AdminSessionTeacherSuggestions))
