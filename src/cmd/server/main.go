...
func main() {
	...
	mux.HandleFunc("GET /vcc", protect(h.VCCIndex))
	mux.HandleFunc("GET /admin/vccs", protect(h.AdminVCCs))
	mux.HandleFunc("GET /admin/vccs/{id}", protect(h.AdminVCCDetail))
	mux.HandleFunc("POST /admin/vccs/{id}/status", protect(h.AdminVCCUpdateStatus))
	mux.HandleFunc("POST /admin/vccs/{id}/units/{uid}", protect(h.AdminVCCUnitUpdate))
	mux.HandleFunc("POST /admin/vccs/{id}/pqs/{pid}", protect(h.AdminVCCPQUpdate))
