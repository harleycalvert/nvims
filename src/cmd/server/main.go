...
func main() {
	...
	mux.HandleFunc("POST /backup/restore", protect(h.RestoreSQL))
	...
	mux.HandleFunc("POST /admin/role-types/{id}/delete", protect(h.AdminRoleTypeDelete))
	...
	mux.HandleFunc("GET /admin/rooms/{id}/issues", protect(h.AdminRoomIssuesList))
	mux.HandleFunc("POST /admin/rooms/{id}/issues/new", protect(h.AdminRoomIssueCreate))
	mux.HandleFunc("POST /admin/rooms/{id}/issues/{iid}", protect(h.AdminRoomIssueUpdate))
	mux.HandleFunc("POST /admin/rooms/{id}/issues/{iid}/delete", protect(h.AdminRoomIssueDelete))
	mux.HandleFunc("GET /admin/rooms/{id}/lab-specs", protect(h.AdminRoomLabSpecsGet))
	mux.HandleFunc("POST /admin/rooms/{id}/lab-specs", protect(h.AdminRoomLabSpecsUpsert))
	mux.HandleFunc("GET /admin/rooms/lab-software/known", protect(h.AdminRoomLabSoftwareKnown))
	mux.HandleFunc("GET /admin/rooms/{id}/lab-software", protect(h.AdminRoomLabSoftwareList))
	mux.HandleFunc("POST /admin/rooms/{id}/lab-software/new", protect(h.AdminRoomLabSoftwareCreate))
	mux.HandleFunc("POST /admin/rooms/{id}/lab-software/{swid}", protect(h.AdminRoomLabSoftwareUpdate))
	mux.HandleFunc("POST /admin/rooms/{id}/lab-software/{swid}/delete", protect(h.AdminRoomLabSoftwareDelete))
	...
	mux.HandleFunc("GET /admin/exceptions", protect(h.AdminExceptions))
	mux.HandleFunc("POST /admin/exceptions/rules/new", protect(h.AdminExceptionRuleCreate))
	mux.HandleFunc("POST /admin/exceptions/rules/{id}", protect(h.AdminExceptionRuleUpdate))
	mux.HandleFunc("POST /admin/exceptions/rules/{id}/delete", protect(h.AdminExceptionRuleDelete))
	mux.HandleFunc("POST /admin/exceptions/observances/new", protect(h.AdminExceptionObservanceCreate))
	mux.HandleFunc("POST /admin/exceptions/observances/{id}/delete", protect(h.AdminExceptionObservanceDelete))
	mux.HandleFunc("POST /admin/exceptions/generate", protect(h.AdminExceptionGenerate))
	...
	mux.HandleFunc("GET /vcc/industry-currency", protect(h.VCCIndustryCurrency))
	mux.HandleFunc("POST /vcc/ind-evidence", protect(h.VCCIndEvidenceCreate))
	mux.HandleFunc("POST /vcc/ind-evidence/{iid}", protect(h.VCCIndEvidenceUpdate))
	mux.HandleFunc("POST /vcc/ind-evidence/{iid}/delete", protect(h.VCCIndEvidenceDelete))
	mux.HandleFunc("POST /vcc/ind-evidence/{iid}/docs", protect(h.VCCIndEvidenceAddDoc))
	mux.HandleFunc("POST /vcc/ind-evidence/{iid}/docs/{did}/delete", protect(h.VCCIndEvidenceDeleteDoc))
	...
	mux.HandleFunc("GET /vcc/programs", protect(h.VCCPrograms))
	mux.HandleFunc("POST /vcc/tccp/publish", protect(h.VCCPublishTCCP))
	mux.HandleFunc("GET /vcc/publications", protect(h.VCCListPublications))
	mux.HandleFunc("GET /vcc/publications/{pid}/download", protect(h.VCCDownloadPublication))
	mux.HandleFunc("POST /vcc/publications/{pid}/delete", protect(h.VCCDeletePublication))
	mux.HandleFunc("POST /vcc/subject-evidence", protect(h.VCCAddSubjectEvidence))
	mux.HandleFunc("POST /vcc/subject-evidence/{lid}/notes", protect(h.VCCUpdateSubjectEvidence))
	mux.HandleFunc("POST /vcc/subject-evidence/{lid}/delete", protect(h.VCCDeleteSubjectEvidence))
