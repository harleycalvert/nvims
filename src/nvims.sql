...
CREATE TABLE IF NOT EXISTS public.leave_requests (
    ...
    partial_start    time NULL,
    partial_end      time NULL,
    notes            text NULL,
    ...
    CONSTRAINT chk_leave_partial CHECK (
        is_partial_day = false
        OR (partial_start IS NOT NULL AND partial_end IS NOT NULL AND partial_end > partial_start)
    )
);
...
CREATE INDEX IF NOT EXISTS idx_leave_dates_date ON public.leave_request_dates (leave_date);
